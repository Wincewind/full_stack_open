...
const App = () => {
  ...
  if (user === null) {
    return (
      <div>
        ...
        <LoginForm handleSubmit={handleLogin} username={username} setUsername={setUsername} password={password} setPassword={setPassword} />
      </div>
    )
  }
  ...
  return (
    <div>
      ...
      {blogs.map(blog =>
        <Blog key={blog.id} blog={blog} updateBlog={updateBlog} deleteBlog={deleteBlog} currentUsername={user.username} />
      )}
    </div>
  )
}
